...
public class FastDFSUtil {
    ...
    public FileInfo upload(MultipartFile file) throws IOException {
        ...
        return new FileInfo().setFilePath(filePath);
    }
    ...
    public String getResAccessUrl(StorePath storePath) {
        return fileHttpUrl + storePath.getFullPath();
    }
    ...
    public FileInfo uploadImage(MultipartFile file, Boolean isThumb) throws IOException {
        if (isThumb) {
            ...
            String filePath = getResAccessUrl(storePath);
            String thumbImagePath = fileHttpUrl + thumbImageConfig.getThumbImagePath(storePath.getFullPath());
            return new FileInfo().setFilePath(filePath).setThumbImagePath(thumbImagePath);
        } else {
