...
CREATE TABLE `sms_coupon`  (
  ...
  `title` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL COMMENT '优惠券标题（有图片则显示图片）：无门槛50元优惠券 | 单品最高减2000元',
  `img` varchar(128)  COMMENT '图片',
  `type` int NOT NULL DEFAULT 1 COMMENT '1满减券 2叠加满减券 3无门槛券（需要限制大小）',
  `publish` varchar(11)  COMMENT '发布状态, PUBLISH发布，DRAFT草稿，OFFLINE下线',
...
CREATE TABLE `sms_coupon_record`  (
  ...
  `use_state` varchar(32)  COMMENT '使用状态  可用 NEW,已使用USED,过期 EXPIRED;',
  `user_id` bigint NULL DEFAULT NULL COMMENT '用户id',
  `user_name` varchar(128)  COMMENT '用户昵称（冗余字段）',
  `coupon_type` int NOT NULL DEFAULT 1 COMMENT '1满减券 2叠加满减券 3无门槛券',
  `coupon_title` varchar(128)  COMMENT '优惠券标题',
  `condition_price` bigint NOT NULL DEFAULT 0 COMMENT '满多少才可以使用（为0则不限制金额）',
  `price` bigint NOT NULL COMMENT '抵扣价格',
...
CREATE TABLE `sms_coupon_template`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '优惠券模板名称',
  `logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '优惠券模板logo',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '优惠券模板描述',
  `category` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '优惠券模板分类',
  ...
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '优惠券模板编码',
  `rule` text CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL COMMENT '优惠券规则',
  `gmt_create` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  `gmt_created_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `gmt_modified` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  `gmt_modified_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sms_seckill_session`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '场次名称',
