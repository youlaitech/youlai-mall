      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.goodsPic" style="height: 80px">
          </template>
        </el-table-column>
        ...
        <el-table-column label="属性" width="120" align="center">
          <template slot-scope="scope">
            {{scope.row.goodsAttr | formatProductAttr}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="小计" width="120" align="center">
          <template slot-scope="scope">
            ￥{{scope.row.goodsPrice*scope.row.goodsQuantity}}
          </template>
        </el-table-column>
      </el-table>
    ...
    methods: {
      ...
      handleUpdateReceiverInfo(){
        this.$confirm('是否要修改收货信息?', '提示', {
          ...
          putReceiverInfo(this.receiverInfo).then(response=>{
