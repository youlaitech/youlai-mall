package com.youlai.mall.order.generator;
 ...
 * @since 2024/6/7
 */
public class OrderAutoGeneratorTest {

    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://localhost:3306/youlai_mall_oms?serverTimezone=Asia/Shanghai", "root", "123456");
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create(DATA_SOURCE_CONFIG)
                ...
                .globalConfig((scanner, builder) -> {
                    builder.outputDir(System.getProperty("user.dir") + "/mall-order/order-boot/src/main/java")
                            .author("Ray Hao") // 设置作者
                    ;
                })
                // 包配置
