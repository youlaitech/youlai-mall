...
CREATE TABLE `sys_menu_test`  (
  ...
  `parent_id` bigint(0) NULL DEFAULT NULL COMMENT '父菜单ID',
  `type` tinyint(0) NULL DEFAULT 0 COMMENT '类型：1-目录 2-菜单 3-按钮',
  `path` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '组件路径',
...
INSERT INTO `sys_menu_test` VALUES (8, '客户端管理', 1, 2, 'admin/client', NULL, NULL, 'tab', 11, 1, 1, '2020-10-17 08:04:08', '2020-10-17 08:04:08');
INSERT INTO `sys_menu_test` VALUES (9, '营销管理', 0, 1, 'sms', NULL, '', 'component', 2, 1, 1, '2020-10-24 15:24:04', '2020-10-31 10:51:53');
INSERT INTO `sys_menu_test` VALUES (10, '广告管理', 9, 2, 'sms/advert', NULL, NULL, 'documentation', 1, 1, 1, '2020-10-24 15:25:15', '2020-10-24 15:25:15');
INSERT INTO `sys_menu_test` VALUES (11, '商品管理', 0, 1, 'pms', NULL, NULL, 'list', 1, 1, 1, '2020-10-31 10:44:58', '2020-10-31 10:51:57');
INSERT INTO `sys_menu_test` VALUES (12, '商品列表', 11, 2, 'pms/product', NULL, NULL, 'component', 1, 1, 1, '2020-11-06 11:54:37', '2020-10-31 10:48:19');
INSERT INTO `sys_menu_test` VALUES (13, '订单管理', 0, 1, 'oms', NULL, NULL, 'list', 3, 1, 1, '2020-10-31 10:49:46', '2020-10-31 10:52:01');
INSERT INTO `sys_menu_test` VALUES (14, '订单列表', 13, 2, 'oms/order', NULL, NULL, 'component', 3, 1, 1, '2020-10-31 10:50:23', '2020-10-31 10:50:38');
INSERT INTO `sys_menu_test` VALUES (15, '会员管理', 0, 1, 'ums', NULL, NULL, 'list', 4, 1, 1, '2020-10-31 10:51:07', '2020-10-31 10:51:07');
INSERT INTO `sys_menu_test` VALUES (16, '会员列表', 15, 2, 'ums/user', NULL, NULL, 'dashboard', 1, 1, 1, '2020-10-31 10:51:43', '2020-10-31 10:51:43');
INSERT INTO `sys_menu_test` VALUES (17, '品牌管理', 11, 2, 'pms/brand', NULL, NULL, 'component', 4, 1, 1, '2020-09-23 09:12:21', '2020-09-23 09:12:21');
INSERT INTO `sys_menu_test` VALUES (18, '类目管理', 11, 2, 'pms/category', NULL, NULL, 'component', 3, 1, 1, '2020-09-23 09:12:21', '2020-09-23 09:12:21');
INSERT INTO `sys_menu_test` VALUES (19, '商品详情', 11, 2, 'pms/product/detail', NULL, NULL, 'component', 2, 0, 1, '2020-11-06 13:16:26', '2020-11-06 11:57:22');
INSERT INTO `sys_menu_test` VALUES (22, '商品上架', 11, 2, 'pms/product/detail', NULL, '', 'component', 2, 1, 1, NULL, NULL);
INSERT INTO `sys_menu_test` VALUES (23, '角色管理', 1, 2, 'admin/role', NULL, '', 'example', 2, 1, 1, NULL, NULL);
INSERT INTO `sys_menu_test` VALUES (25, '实验室', 0, 1, 'laboratory', NULL, '', 'component', 9, 1, 1, NULL, NULL);
INSERT INTO `sys_menu_test` VALUES (26, 'Seata分布式事务', 25, 2, 'laboratory/seata', NULL, '', 'component', 1, 1, 1, NULL, NULL);
INSERT INTO `sys_menu_test` VALUES (28, '权限管理', 1, 2, 'admin/permission', NULL, '', 'component', 9, 1, 1, NULL, NULL);
