   ...
   /* private final MenuService menuService;*/
    ...
    public GenConfigForm getGenConfigFormData(String tableName) {
        ...
        if (genConfig == null) {
            ...
            // 默认模块名
            genConfig.setModuleName(generatorProperties.getDefaultConfig().getModuleName());
    ...
    private void generatorCode(String tableName, ZipOutputStream zip) {
        List<CodePreviewVO> previewVOList = getCodePreviewData(tableName);
        for (CodePreviewVO previewVO : previewVOList) {
