...
CREATE TABLE `sms_coupon`  (
  ...
  `validity_start_time` datetime NULL DEFAULT NULL COMMENT '有效期起始时间',
  ...
  `is_deleted` tinyint NULL DEFAULT 1 COMMENT '逻辑删除标识(0-正常;1-删除)',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sms_coupon_spu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1548148841429663755 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
