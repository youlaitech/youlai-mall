...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1, '查看用户', 2, 'GET_/youlai-admin/api/v1/users/**', 'system:user:view', '2021-02-02 14:16:07', '2021-06-06 23:37:26');
...
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'ROOT', 1, 1, '2021-05-21 14:56:51', '2018-12-23 16:00:00', 0);
INSERT INTO `sys_role` VALUES (2, '系统管理员', 'ADMIN', 2, 1, '2021-03-25 12:39:54', '2018-12-23 16:00:00', 0);
INSERT INTO `sys_role` VALUES (3, '游客', 'GUEST', 3, 1, '2021-05-26 15:49:05', '2019-05-05 16:00:00', 0);
INSERT INTO `sys_role` VALUES (67, '测试', 'TEST', 1, 1, '2021-06-05 01:30:40', '2021-06-05 01:30:40', 0);
...
INSERT INTO `sys_role_menu` VALUES (67, 6);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'root', '超级管理员', 2, '$2a$10$P97nHj/AVu6JBVCxmj5qEOwsI7rUhFeyu.DrK4ER7sebzv8jp7R5S', 1, 'https://gitee.com/haoxr/image/raw/master/20210605215800.png', '17621590365', 1, '1490493387@qq.com', '2021-02-10 12:27:30', '2021-06-06 23:36:51', 0);
INSERT INTO `sys_user` VALUES (2, 'admin', '系统管理员', 1, '$2a$10$yJSqqr6sTxNuYtA6EKcVUe2I4USFCzJ29sNcRrBvtAkSYcNg5ydQ6', 2, 'https://gitee.com/haoxr/image/raw/master/20210605215800.png', '17621210366', 1, '1490493387@qq.com', '2019-10-10 13:41:22', '2021-06-06 23:41:35', 0);
INSERT INTO `sys_user` VALUES (3, 'test', '测试小用户', 1, '$2a$10$MPJkNw.hKT/fZOgwYP8q9eu/rFJJDsNov697AmdkHNJkpjIpVSw2q', 1, 'https://gitee.com/haoxr/image/raw/master/20210605215800.png', NULL, 1, NULL, '2021-06-05 01:31:29', '2021-06-05 01:31:29', 0);
