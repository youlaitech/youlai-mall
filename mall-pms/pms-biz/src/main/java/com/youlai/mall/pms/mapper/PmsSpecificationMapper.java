...
public interface PmsSpecificationMapper  extends BaseMapper<PmsSpecification> {
    ...
    @Results({
            ...
            @Result(property = "values", column = "{specificationId= t1.id,spuId=spuId}", many = @Many(select = "com.youlai.mall.pms.mapper.PmsSpecificationValueMapper.listByParentId"))
    })
